...
<div class="main" id="main">
    ...
    <?php 
        ...
        echo '<form action="" method="post">
                <button type="submit" name="all">
                    <div class="box" style="background-image: url(images/ayurveda.jpg);">
                        <div class="content">
                            All
             ...
             $sqlquery = "SELECT * From `categories` where `categorie`='Ayurveda'";
   ...
   <div class="display">
        ...
        if (isset($_POST["category_box"])) {
            ...
            <div class="container-fluid overflow-hidden text-center">
                <div class="row g-5 mx-2 align-items-start">
                    <?php
                    $query = 'Select * from stocks where sub_category="'.$categorytype.'" and  category="Ayurveda" and qty>"0"';
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<div class="col col-lg-2">
                                <form action="insertintocart.php" method="POST">
                                    <a href="product.php?id='. $row["id"] .'&page=proayurvedh">
                                        <div class="card" style="width: 10rem; border-style: none; position: static;">
                                            <img src="images/' . $image . '" class="card-img-top" alt="' . $image . '" style="height:120px;">
                                            <div class="card-body">
        ...
        <?php  } 
            // if no categories is pressed
                ...
                echo '<br>';
                $query = "Select * from stocks where category='Ayurveda' and qty >'0';";
                $result = mysqli_query($conn, $query);
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    $check_status=mysqli_query($conn, "SELECT * From `categories` where `status`='Avaliable' and `cname`='$row[sub_category]' and `categorie`='Ayurveda';");
   ...
   <script>
    function allopathy()
        {
            window.location="proallopathy.php";
        }
